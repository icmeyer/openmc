...
from .gnds import gnds_from_ace, XYs1D
...
def _get_fission_products_ace(ace):
    ...
    if ace.jxs[24] > 0:
        yield_delayed = gnds_from_ace(ace, ace.jxs[24] + 1)
        ...
        for group in range(n_group):
            ...
            group_probability = gnds_from_ace(ace, idx + 1)
...
def _get_photon_products_ace(ace, rx):
    ...
    for i in range(n_photon_reactions):
        ...
        if mftype in (12, 16):
            ...
            photon.yield_ = gnds_from_ace(ace, idx + 1)
        ...
        if i_reaction > 0:
            ...
            if i_reaction < ace.nxs[5] + 1:
                ...
                while lnw > 0:
                    ...
                    neutron.applicability.append(gnds_from_ace(
